...
class StudentResultOverviewState extends State<StudentResultOverview> {
  Color setColor(int percentage) {
    ...
    for (int i = 0; i < 10; i++) {
      if (((10 * i) <= percentage) && ((10 * (i + 1)) > percentage)) {
        return colors[i];
      }
    }
  }
                        ...
                        children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                              "${universities[results[index].scholarship.universityIndex].city}"),
                                          Text(
                                            "City",
                                            style: TextStyle(fontSize: 30),
                                          ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  " ${results[index].scholarship.studyLevel} in ${results[index].scholarship.specification}",
                                  style: TextStyle(
                                      fontSize: 25,
                                      color: Colors.blue.shade700),
                                ),
