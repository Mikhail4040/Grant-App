...
import 'package:work/Scholarship.dart';
...
class SingleScholarshipOverviewState extends State<SingleScholarshipOverview> {
  ...
  int lastSelected = 0;
  List<bool> isSelected = new List<bool>.filled(11, false, growable: true);
  List languages = [
    "Chinese",
    "Spanish",
    "English",
  ...
  void save() {
    setState(() {
      ...
      if ((specificationError.length == 0) &&
        ...
        if(newScholarship == scholarship){
          //TODO..printing nothing changed.
        }

        for(int i=0;i<universityScholarships.length;i++){
          if(newScholarship == universityScholarships[i]){
            //TODO..printing there is exactly the same scholarship in your list.
            return;
          }
        }
  ...
  void delete() {
    setState(() {
      ...
      if ((specificationError.length == 0) &&
        ...
        universityScholarships.removeAt(scholarshipIndex);
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(100, 0, 150, 10),
                          decoration: BoxDecoration(
                            border: Border.all(color: Colors.black, width: 1),
                            borderRadius: BorderRadius.all(Radius.circular(10)),
                          ),
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        height: 40,
                        width: 120,
                        margin: EdgeInsets.fromLTRB(1, 30, 30, 1),
                        child: RaisedButton(
                          onPressed: () {
                            delete();
                          },
